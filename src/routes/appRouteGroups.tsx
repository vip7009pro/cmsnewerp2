...
export function KinhDoanhRouteGroup(globalUserData: any) {
  return (
    <Route
      path="kinhdoanh"
      element={
        <ProtectedRoute user={globalUserData} maindeptname="all" jobname="Leader">
          <KinhDoanh />
        </ProtectedRoute>
      }
    >
      ...
      <Route path="quotationmanager" element={<QuotationTotal />} />
...
export function RndRouteGroup(globalUserData: any) {
  return (
    <Route
      path="rnd"
      element={
...
export function QlsxRouteGroup(globalUserData: any) {
  return (
    <Route
      path="qlsx"
      element={
...
export function PhongMuaHangRouteGroup(globalUserData: any) {
  return (
    <Route
      path="phongmuahang"
      element={
...
export function BoPhanKhoRouteGroup(globalUserData: any) {
  return (
    <Route
      path="bophankho"
      element={
...
export function SettingRouteGroup(globalUserData: any) {
  return (
    <Route
      path="setting"
      element={
...
export function QcRouteGroup(globalUserData: any) {
  return (
    <Route
      path="qc"
      element={
        <ProtectedRoute user={globalUserData} maindeptname="all" jobname="all">
          <QC />
        </ProtectedRoute>
      }
    >
...
export function ToolRouteGroup({ globalUserData }: { globalUserData: any }) {
  return (
    <Route
      path="tool"
      element={
...
export function InformationBoardRouteGroup({ globalUserData }: { globalUserData: any }) {
  return (
    <Route
...
export function SxRouteGroup({ globalUserData }: { globalUserData: any }) {
  return (
    <Route
      path="sx"
      element={
    ...
    >
      ...
      />
      <Route path="datasx" element={<BAOCAOSXALL />} />
      <Route
        path="planstatus"
        element={
          <ProtectedRoute user={globalUserData} maindeptname="all" jobname="Leader">
...
export function NhanSuRouteGroup({ globalUserData }: { globalUserData: any }) {
  return (
    <Route
      path="nhansu"
      element={
    ...
    >
      ...
      />
      <Route path="lichsu" element={<LichSu_New />} />
      <Route
        path="baocaonhansu"
        element={
          <ProtectedRoute user={globalUserData} maindeptname="all" jobname="leader">
      ...
      <Route
        path="listchamcong"
        element={
          <ProtectedRoute user={globalUserData} maindeptname="NS" jobname="leader">
            <BANGCHAMCONG />
          </ProtectedRoute>
        }
      />
