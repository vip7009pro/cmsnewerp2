...
const PlanManager = () => {
  ...
  const column_plantable = [  
    ...
    { field: "D1", headerName: "D1", width: 80 , renderCell: (params:any) => {return <span style={{color:'blue'}}><b>{params.row.D1.toLocaleString('en-US')}</b></span>} },
    { field: "D2", headerName: "D2", width: 80 , renderCell: (params:any) => {return <span style={{color:'blue'}}><b>{params.row.D2.toLocaleString('en-US')}</b></span>} },
    { field: "D3", headerName: "D3", width: 80 , renderCell: (params:any) => {return <span style={{color:'blue'}}><b>{params.row.D3.toLocaleString('en-US')}</b></span>} },
    { field: "D4", headerName: "D4", width: 80 , renderCell: (params:any) => {return <span style={{color:'blue'}}><b>{params.row.D4.toLocaleString('en-US')}</b></span>} },
    { field: "D5", headerName: "D5", width: 80 , renderCell: (params:any) => {return <span style={{color:'blue'}}><b>{params.row.D5.toLocaleString('en-US')}</b></span>} },
    { field: "D6", headerName: "D6", width: 80 , renderCell: (params:any) => {return <span style={{color:'blue'}}><b>{params.row.D6.toLocaleString('en-US')}</b></span>} },
    { field: "D7", headerName: "D7", width: 80 , renderCell: (params:any) => {return <span style={{color:'blue'}}><b>{params.row.D7.toLocaleString('en-US')}</b></span>} },
    { field: "D8", headerName: "D8", width: 80 , renderCell: (params:any) => {return <span style={{color:'blue'}}><b>{params.row.D8.toLocaleString('en-US')}</b></span>} },
  ...
  const column_excelplan2 = [
    ...
    { field: "PLAN_DATE", headerName: "PLAN_DATE", width: 120 },
    { field: "D1", headerName: "D1", width: 120, renderCell: (params:any) => {return <span style={{color:'blue'}}><b>{params.row.D1.toLocaleString('en-US')}</b></span>}  },
    { field: "D2", headerName: "D2", width: 120 , renderCell: (params:any) => {return <span style={{color:'blue'}}><b>{params.row.D2.toLocaleString('en-US')}</b></span>} },
    { field: "D3", headerName: "D3", width: 120 , renderCell: (params:any) => {return <span style={{color:'blue'}}><b>{params.row.D3.toLocaleString('en-US')}</b></span>} },
    { field: "D4", headerName: "D4", width: 120 , renderCell: (params:any) => {return <span style={{color:'blue'}}><b>{params.row.D4.toLocaleString('en-US')}</b></span>} },
    { field: "D5", headerName: "D5", width: 120 , renderCell: (params:any) => {return <span style={{color:'blue'}}><b>{params.row.D5.toLocaleString('en-US')}</b></span>} },
    { field: "D6", headerName: "D6", width: 120 , renderCell: (params:any) => {return <span style={{color:'blue'}}><b>{params.row.D6.toLocaleString('en-US')}</b></span>} },
    { field: "D7", headerName: "D7", width: 120 , renderCell: (params:any) => {return <span style={{color:'blue'}}><b>{params.row.D7.toLocaleString('en-US')}</b></span>} },
    { field: "D8", headerName: "D8", width: 120 , renderCell: (params:any) => {return <span style={{color:'blue'}}><b>{params.row.D8.toLocaleString('en-US')}</b></span>} },
    { field: "REMARK", headerName: "REMARK", width: 120 },   
