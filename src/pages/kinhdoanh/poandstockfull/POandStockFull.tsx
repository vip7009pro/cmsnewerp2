...
const POandStockFull = () => {
  ...
  const column_codeCMS = [
    ...
    { field: "TONG_TON_KIEM", type: 'number', headerName: "Total TKiem", width: 110 , renderCell: (params:any) => {return <span style={{color:'yellow'}}><b>{params.row.TONG_TON_KIEM.toLocaleString('en-US')}</b></span>}},
    { field: "BTP", type: 'number', headerName: "BTP", width: 90 , renderCell: (params:any) => {return <span style={{color:'yellow'}}><b>{params.row.BTP.toLocaleString('en-US')}</b></span>}},
    { field: "TON_TP", type: 'number', headerName: "TON_TP", width: 90, renderCell: (params:any) => {return <span style={{color:'yellow'}}><b>{params.row.TON_TP.toLocaleString('en-US')}</b></span>} },
  ...
  const column_codeKD = [
    ...
    { field: "TONG_TON_KIEM", type: 'number',headerName: "Total TKiem", width: 90 , renderCell: (params:any) => {return <span style={{color:'yellow'}}><b>{params.row.TONG_TON_KIEM.toLocaleString('en-US')}</b></span>}},
    { field: "BTP", type: 'number',headerName: "BTP", width: 90 , renderCell: (params:any) => {return <span style={{color:'yellow'}}><b>{params.row.BTP.toLocaleString('en-US')}</b></span>}},
    { field: "TON_TP", type: 'number',headerName: "TON_TP", width: 90, renderCell: (params:any) => {return <span style={{color:'yellow'}}><b>{params.row.TON_TP.toLocaleString('en-US')}</b></span>} },
    { field: "BLOCK_QTY", type: 'number',headerName: "BLOCK_QTY", width: 90 , renderCell: (params:any) => {return <span style={{color:'blue'}}><b>{params.row.BLOCK_QTY.toLocaleString('en-US')}</b></span>}},
