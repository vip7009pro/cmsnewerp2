          ...
          <ResponsiveContainer>
            ...
            >
              ...
              <Pager
                ...
                displayMode='compact'
              />
              <Column dataField='KNIFE_FILM_ID' caption='KNIFE_FILM_ID' width={100}></Column>
            <Column dataField='FACTORY_NAME' caption='FACTORY_NAME' width={100}></Column>
            <Column dataField='NGAYBANGIAO' caption='NGAYBANGIAO' width={100}></Column>
            ...
            <Column dataField='LOAIBANGIAO_PDP' caption='LOAIBANGIAO_PDP' width={100}></Column>
            <Column dataField='LOAIPHATHANH' caption='LOAIPHATHANH' width={100}></Column>
            <Column dataField='SOLUONG' caption='SOLUONG' width={100}></Column>
            <Column dataField='SOLUONGOHP' caption='SOLUONGOHP' width={100}></Column>
            <Column dataField='LYDOBANGIAO' caption='LYDOBANGIAO' width={100}></Column>
            <Column dataField='PQC_EMPL_NO' caption='PQC_EMPL_NO' width={100}></Column>
            <Column dataField='RND_EMPL_NO' caption='RND_EMPL_NO' width={100}></Column>
            <Column dataField='SX_EMPL_NO' caption='SX_EMPL_NO' width={100}></Column>
            <Column dataField='REMARK' caption='REMARK' width={100}></Column>
            <Column dataField='CFM_GIAONHAN' caption='CFM_GIAONHAN' width={100}></Column>
            <Column dataField='CFM_INS_EMPL' caption='CFM_INS_EMPL' width={100}></Column>
            <Column dataField='CFM_DATE' caption='CFM_DATE' width={100}></Column>
            <Column dataField='KNIFE_FILM_STATUS' caption='KNIFE_FILM_STATUS' width={100}></Column>
            <Column dataField='MA_DAO' caption='MA_DAO' width={100}></Column>
            <Column dataField='TOTAL_PRESS' caption='TOTAL_PRESS' width={100}></Column>
            <Column dataField='CUST_CD' caption='CUST_CD' width={100}></Column>
            <Column dataField='KNIFE_TYPE' caption='KNIFE_TYPE' width={100}></Column>
