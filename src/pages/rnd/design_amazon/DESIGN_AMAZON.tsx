...
const DESIGN_AMAZON = () => {
  ...
  const saveDesignAmazon = async ()=> {
    if(codedatatablefilter.length>0)
    {
      let checkExist:boolean = await checkDesignExist(codedatatablefilter[0].G_CODE);
  ...
  return (
    <div className='design_window'>
      <div className='design_control' id='dsg_ctrl'>
        {showhidecodelist && <div className='codelist'>
      ...
      <div className='design_panel'>
        ...
        <IconButton
          ...
          X:<input type='number' step={0.01} value={x*0.26458333333719} onChange={(e)=> { console.log(Number(e.target.value)/0.26458333333719); setX(Number(e.target.value)/0.26458333333719);}} style={{width:'80px'}}></input> (mm)
          Y:<input type='number' step={0.01} value={y*0.26458333333719} onChange={(e)=> { console.log(Number(e.target.value)/0.26458333333719); setY(Number(e.target.value)/0.26458333333719);}} style={{width:'80px'}}></input> (mm)
        </div>
        <div
          id="10a"
        ...
        >        
          <Draggable   
            ...
            onDragMove={(e: any) => {
              var offsets1 = document.getElementById('10a')?.getBoundingClientRect();
              var offsets2 = document.getElementById('11a')?.getBoundingClientRect();
