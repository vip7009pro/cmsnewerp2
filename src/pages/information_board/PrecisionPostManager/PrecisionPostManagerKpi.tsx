...
const PrecisionPostManagerKpi: React.FC<{ data: KpiProps }> = ({ data }) => {
  return (
    <div className="precision-postmanager__kpiGrid">
      {/* 1. Tổng Bài Đăng */}
      <div className="kpi-card kpi-card--blue">
        ...
        <div className="kpi-card__meta">
          ...
          <span className="kpi-card__pill">Hệ thống</span>
        </div>
      </div>

      {/* 2. Tin Phát Hành Tháng Này */}
      <div className="kpi-card kpi-card--green">
        <div className="kpi-card__header">
          <span className="kpi-card__title">Tháng Này</span>
          <span className="kpi-card__iconWrap">
            <FiCalendar size={14} />
          </span>
        </div>
        ...
        <div className="kpi-card__meta">
          <span>Tỷ trọng: {data.total > 0 ? ((data.thisMonthCount / data.total) * 100).toFixed(0) : 0}%</span>
          <span className="kpi-card__pill">Tháng hiện tại</span>
        </div>
      </div>
      ...
      <div className="kpi-card kpi-card--purple">
        <div className="kpi-card__header">
          <span className="kpi-card__title">Đa Phương Tiện</span>
          <span className="kpi-card__iconWrap">
            <FiImage size={14} />
          </span>
        </div>
      ...
      <div className="kpi-card kpi-card--amber">
        <div className="kpi-card__header">
          <span className="kpi-card__title">Ghim Nổi Bật</span>
          <span className="kpi-card__iconWrap">
            <FiBookmark size={14} />
          </span>
        </div>
        ...
        <div className="kpi-card__meta">
          <span>Thông cáo ưu tiên</span>
          <span className="kpi-card__pill">Ghim đầu</span>
        </div>
      </div>

      {/* 5. Phòng Ban Năng Động Nhất */}
      <div className="kpi-card kpi-card--indigo">
        <div className="kpi-card__header">
          <span className="kpi-card__title">Phòng Năng Động</span>
          <span className="kpi-card__iconWrap">
            <FiAward size={14} />
          </span>
        </div>
        <div
          ...
          title={data.topDeptName}
        >
          {data.topDeptName}
        </div>
        <div className="kpi-card__meta">
          <span>Số bài đóng góp</span>
      ...
      <div className="kpi-card kpi-card--rose">
        ...
        <div className="kpi-card__value" style={{ fontSize: "14px" }}>
          {data.topAuthorName}
        </div>
        <div className="kpi-card__meta">
          <span>Số bài đã tạo</span>
...
export default React.memo(PrecisionPostManagerKpi);
