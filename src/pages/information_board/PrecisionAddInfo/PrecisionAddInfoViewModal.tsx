...
const PrecisionAddInfoViewModal: React.FC<ModalProps> = ({ post, onClose }) => {
  if (!post) return null;
  ...
  return (
    <div className="reader-modal" onClick={onClose}>
      <div className="reader-modal__card" onClick={(e) => e.stopPropagation()}>
        <div className="reader-modal__header">
          ...
          <button
            type="button"
            className="reader-modal__closeBtn"
            onClick={onClose}
            title="Đóng cửa sổ"
          >
            <FiX />
...
export default React.memo(PrecisionAddInfoViewModal);
