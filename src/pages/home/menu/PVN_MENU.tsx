...
export const PVN_MENU= (lang?: string) => { 
    return [
      ...
      {
        MENU_CODE: 'KD16',
        MENU_NAME: getLangSafe('yctk', lang),
        MENU_ITEM: <YCTKManager />,
      },
      {
        MENU_CODE: 'PU1',
      ...
      {
        MENU_CODE: 'SX9',
        MENU_NAME: getLangSafe('lichsuxuatlieuthat', lang),
        MENU_ITEM: <LICHSUINPUTLIEU />,
      },
      {
        MENU_CODE: 'SX10',
        MENU_NAME: getLangSafe('materiallotstatus', lang),
        MENU_ITEM: <TINHHINHCUONLIEU />,
      },
      {
        MENU_CODE: 'SX13',
        MENU_NAME: getLangSafe('sxrolldata', lang),
        MENU_ITEM: <BCSX />,
      },
      {
        MENU_CODE: 'SX14',
        MENU_NAME: getLangSafe('lichsutemlotsx', lang),
