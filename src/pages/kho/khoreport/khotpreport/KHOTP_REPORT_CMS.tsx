  ...
  return (
    <div className='khovlreport'>
      ...
      <div className='doanhthureport'>
        ...
        <div className='graph'>
          <span className='section_title'>1. Tình hình tồn kho dài hạn</span>{<div style={{ display: 'flex', alignItems: 'center' }}>Mốc 1: <input type="number" value={moc1} style={{width: '50px'}} onChange={(e) => setMoc1(Number(e.target.value))} /> Mốc 2: <input type="number" value={moc2} style={{width: '50px'}} onChange={(e) => setMoc2(Number(e.target.value))}/>
          <button
            className='searchbutton'
            onClick={() => {
              initFunction();
