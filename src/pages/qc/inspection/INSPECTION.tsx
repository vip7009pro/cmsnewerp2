...
const INSPECTION = () => { 
  ...
  const column_inspect_input = [
    ...
    { field: "G_NAME", headerName: "Tên SP", width: 150 },
    ...
    { field: "PROD_REQUEST_QTY", headerName: "SL YC", width: 80 , renderCell: (params:any) => {return <span style={{color:'blue'}}><b>{params.row.PROD_REQUEST_QTY.toLocaleString('en-US')}</b></span>}},
  ...
  const column_inspect_output = [
    ...
    { field: "EMPL_NAME", headerName: "Nhân viên", width: 80 },
    { field: "G_CODE", headerName: "G_CODE", width: 80 },
    ...
    { field: "PROCESS_LOT_NO", headerName: "LOT SX", width: 80 },
    { field: "PROD_DATETIME", headerName: "Ngày SX", width: 150 },
    { field: "OUTPUT_DATETIME", headerName: "Ngày Xuất Kiểm", width: 150 },
    { field: "OUTPUT_QTY_EA", headerName: "SL XUẤT KIỂM", width: 80 , renderCell: (params:any) => {return <span style={{color:'blue'}}><b>{params.row.OUTPUT_QTY_EA.toLocaleString('en-US')}</b></span>}},
