...
import { AUDIT_CHECKLIST_RESULT, AUDIT_LIST, AUDIT_RESULT, CSCONFIRM_DATA, CS_CNDB_DATA, CS_RMA_DATA, CS_TAXI_DATA, WEB_SETTING_DATA } from "../../../../api/GlobalInterface";
...
const AUDIT = () => {
  ...
  const [option, setOption] = useState("checklist");
