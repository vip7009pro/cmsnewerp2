    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <span>Quét Mã Chỉ Thị LINE QC</span>
        </div>
        <IconButton
          size="small"
          onClick={onClose}
      ...
      <DialogContent sx={{ p: "12px", display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        >
          Hướng camera vào mã vạch Barcode hoặc QR Code trên phiếu chỉ thị sản xuất
        </div>
      </DialogContent>
    </Dialog>
  );
