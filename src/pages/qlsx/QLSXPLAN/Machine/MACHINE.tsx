...
const MACHINE = () => {
  ...
  const [lichsunhapkhoaotable, setLichSuNhapKhoAoTable] = useState<LICHSUNHAPKHOAO[]>([]);
...
>([]);
  ...
  const [lichsuinputlieudatafilter, setLichSuInputLieuDataFilter] = useState<Array<LICHSUINPUTLIEUSX>>([]);
  ...
  const [qlsxchithidatafilter, setQlsxChiThiDataFilter] = useState<Array<QLSXCHITHIDATA>>([]);
  const [tonlieuxuongdatatable, setTonLieuXuongDataTable] = useState<Array<TONLIEUXUONG>>([]);
  const [tonlieuxuongdatafilter, setTonLieuXuongDataFilter] = useState<Array<TONLIEUXUONG>>([]);
  ...
  const column_chithidatatable =[
    ...
    { field: "OUT_CFM_QTY", headerName: "OUT_KHO_THAT", width: 110, editable: editchithi },
    { field: "INS_EMPL", headerName: "INS_EMPL", width: 120, editable: false , hide: true },
  ...
  const column_tonlieuxuongtable =[
    ...
    { field: "PLAN_ID_INPUT", headerName: "PLAN_ID", width: 80, editable: false },    
  ...
  const column_lichsuinputlieusanxuat = [
    ...
    { field: "REMAIN_QTY", headerName: "REMAIN_QTY", width: 90, editable: true },
  ...
  const handle_loadEQ_STATUS =()=> {
    ...
    .then((response) => {
      ...
      if (response.data.tk_status !== "NG") {
        const loaded_data: EQ_STATUS[] = response.data.data.map((element: EQ_STATUS, index: number)=> {
          return {
            ...element,
            id: index
          }
  ...
  const handle_saveConfirmLieuTon = ()=>
  {
    if(lichsuinputlieudatafilter.length>0)
    {
      ...
      {
        if(lichsuinputlieudatafilter[i].INPUT_QTY >= lichsuinputlieudatafilter[i].REMAIN_QTY)
        {
        ...
        {
          err_code += '| ' + 'Liệu: ' + lichsuinputlieudatafilter[i].M_NAME + ': Confirm Tồn nhiều hơn xuất\n';
        }
  ...
  const handle_loadlichsuinputlieu = (PLAN_ID:string)=>
  {
    ...
    .then((response) => {
      console.log(response.data.data);
      if (response.data.tk_status !== "NG") {
        const loaded_data: LICHSUINPUTLIEUSX[] = response.data.data.map((element: LICHSUINPUTLIEUSX, index: number)=> {
          return {
            ...element,
  ...
  const handle_loadlichsunhapkhoao = ()=> {
    ...
    .then((response) => {
      //console.log(response.data.data);
      if (response.data.tk_status !== "NG") {
        const loaded_data: LICHSUNHAPKHOAO[] = response.data.data.map((element: LICHSUNHAPKHOAO, index: number)=> {
          return {
            ...element,
            INS_DATE: moment(element.INS_DATE).utc().format('YYYY-MM-DD HH:mm:ss'),
            id: index
  ...
  const handle_loadlichsuxuatkhoao = ()=> {
    ...
    .then((response) => {
      //console.log(response.data.data);
      if (response.data.tk_status !== "NG") {
        const loaded_data: LICHSUXUATKHOAO[] = response.data.data.map((element: LICHSUXUATKHOAO, index: number)=> {
          return {
            ...element,
            INS_DATE: moment(element.INS_DATE).utc().format('YYYY-MM-DD HH:mm:ss'),
            id: index
    ...
    if(qlsxplandatafilter.length >0)
    {
      if(tonlieuxuongdatafilter.length >0)
      {
        ...
        for(let i=0;i<tonlieuxuongdatafilter.length;i++)
        {
          ...
          {
            err_code += "| " +  "Liệu: " + tonlieuxuongdatafilter[i].M_NAME + " chưa được đăng ký xuất liệu \n Đã xuất các liệu hợp lệ";
          }
  ...
  const handle_loadKhoAo = () => {
    ...
    .then((response) => {
      //console.log(response.data.data);
      if (response.data.tk_status !== "NG") {
        const loaded_data: TONLIEUXUONG[] = response.data.data.map((element: TONLIEUXUONG, index: number)=> {
          return {
            ...element,
            id: index
          }
  ...
  function CustomToolbarKHOAO() {
    return (
      <GridToolbarContainer>
        ...
        <GridToolbarQuickFilter />
        <div className="div" style={{fontSize:20, fontWeight:'bold'}}>Tồn kho ảo</div>
        <IconButton
          className='buttonIcon'
          onClick={() => { 
            handle_xuatKhoAo();
  ...
  function CustomToolbarNHAPKHOAO() {
    return (
      <GridToolbarContainer>
        ...
        <GridToolbarQuickFilter />
        <div className="div" style={{fontSize:20, fontWeight:'bold'}}>Lịch sử nhập kho ảo</div>        
  ...
  function CustomToolbarXUATKHOAO() {
    return (
      <GridToolbarContainer>
        ...
        <GridToolbarQuickFilter />
        <div className="div" style={{fontSize:20, fontWeight:'bold'}}>Lịch sử xuất kho ảo</div>
        <IconButton
          className='buttonIcon'
          onClick={() => { 
  ...
  const handleQLSXPlanDataSelectionforUpdate = (ids: GridSelectionModel) => {
    ...
    if (datafilter.length > 0) {
      ...
      setDataDinhMuc({...datadinhmuc,
        FACTORY: datafilter[0].FACTORY === null? '': datafilter[0].FACTORY,
        EQ1: datafilter[0].EQ1 === null? 'NA': datafilter[0].EQ1 === ''? 'NO':datafilter[0].EQ1,
        EQ2: datafilter[0].EQ2 === null? 'NA': datafilter[0].EQ2 === ''? 'NO':datafilter[0].EQ2,
        ...
        LOSS_SETTING1: datafilter[0].LOSS_SETTING1 === null? 0: datafilter[0].LOSS_SETTING1,
        LOSS_SETTING2: datafilter[0].LOSS_SETTING2 === null? 0: datafilter[0].LOSS_SETTING2,
  ...
  const handleTonLieuXuongDataSelectionforUpdate = (ids: GridSelectionModel) => {
    const selectedID = new Set(ids);
  ...
  const handleLichSuXuatKhoAoDataSelectionforUpdate = (ids: GridSelectionModel) => {
    const selectedID = new Set(ids);
  ...
  const handleLichSuInputSXDataSelectionforUpdate = (ids: GridSelectionModel) => {
    const selectedID = new Set(ids);
      ...
      {selection.tab1 && (
          <div className="NM1">
            ...
            <div className='FRlist'>
              {
                eq_status.filter((element:EQ_STATUS, index: number)=> element.FACTORY==='NM1' && element.EQ_NAME.substring(0,2)==='FR' ).map((element: EQ_STATUS, index: number)=>{
            ...
            <div className='SRlist'>
              {
                eq_status.filter((element:EQ_STATUS, index: number)=> element.FACTORY==='NM1' && element.EQ_NAME.substring(0,2)==='SR' ).map((element: EQ_STATUS, index: number)=>{
            ...
            <div className='DClist'>
              {
                eq_status.filter((element:EQ_STATUS, index: number)=> element.FACTORY==='NM1' && element.EQ_NAME.substring(0,2)==='DC' ).map((element: EQ_STATUS, index: number)=>{
            ...
            {
                eq_status.filter((element:EQ_STATUS, index: number)=> element.FACTORY==='NM1' && element.EQ_NAME.substring(0,2)==='ED' ).map((element: EQ_STATUS, index: number)=>{
      ...
      {selection.tab2 && (
          <div className="NM2">
           {/*  <span className='machine_title'>SUPER ROTARY-NM2</span>
            ...
            <div className='FRlist'>
              {
                eq_status.filter((element:EQ_STATUS, index: number)=> element.FACTORY==='NM2' && element.EQ_NAME.substring(0,2)==='FR' ).map((element: EQ_STATUS, index: number)=>{
            ...
            <div className='EDlist'>
            {
                eq_status.filter((element:EQ_STATUS, index: number)=> element.FACTORY==='NM2' && element.EQ_NAME.substring(0,2)==='ED' ).map((element: EQ_STATUS, index: number)=>{
              ...
              <div className='tracuuYCSX'>
                ...
                {showkhoao && (
                  <div className='khoaodiv'>
                    ...
                    <div className="nhapxuatkhoao" style={{height:'100%', width:'50%'}}>
                      <div className="nhapkhoao" style={{height:'100%', width:'100%'}}>
                      <DataGrid
                      sx={{ fontSize: 12, flex: 1 }}
                      components={{
                    ...
                    />
                      ...
                      <div className="xuatkhoao" style={{height:'100%', width:'100%'}}>
                      <DataGrid
                      sx={{ fontSize: 12, flex: 1 }}
                      components={{
              ...
              <div className='forminputcolumn'>
                    <label>
                        ...
                        <select
                          ...
                          onChange={(e) => setDataDinhMuc({...datadinhmuc, EQ1: e.target.value })}
                    ...
                    <label>
                        ...
                        <select
                          ...
                          onChange={(e) => setDataDinhMuc({...datadinhmuc, EQ2: e.target.value })}
                          style={{width:150, height: 22}}
                        >
                          <option value='FR'>FR</option>
                          <option value='SR'>SR</option>
              ...
              <div className='forminputcolumn'>
                      <label>
                        ...
                        <input                          
                          ...
                          onChange={(e) => setDataDinhMuc({...datadinhmuc, Setting1: Number(e.target.value) })}
                        ></input>
                      </label>
                      <label>
                        <b>Setting2(min):</b>{" "}
                        <input                          
                          ...
                          onChange={(e) => setDataDinhMuc({...datadinhmuc, Setting2: Number(e.target.value) })}
                        ></input>
                      </label>
                </div>            
              <div className='forminputcolumn'>
                      <label>
                        ...
                        <input                          
                          ...
                          onChange={(e) => setDataDinhMuc({...datadinhmuc, UPH1: Number(e.target.value) })}
                        ></input>
                      </label>
                      <label>
                        <b>UPH2(EA/h):</b>{" "}
                        <input                         
                          ...
                          onChange={(e) => setDataDinhMuc({...datadinhmuc, UPH2: Number(e.target.value) })}
                        ></input>
                      </label>
                </div>            
              <div className='forminputcolumn'>
                      <label>
                        ...
                        <input                          
                          ...
                          onChange={(e) => setDataDinhMuc({...datadinhmuc, Step1: Number(e.target.value) })}
                        ></input>
                      </label>
                      <label>
                        <b>Step2:</b>{" "}
                        <input                          
                          ...
                          onChange={(e) => setDataDinhMuc({...datadinhmuc, Step2: Number(e.target.value) })}
                        ></input>
                      </label>
                </div>            
              <div className='forminputcolumn'>
                      <label>
                        ...
                        <input                          
                          ...
                          onChange={(e) => setDataDinhMuc({...datadinhmuc, LOSS_SX1: Number(e.target.value) })}
                        ></input>
                      </label>
                      <label>
                        <b>LOSS_SX2(%):</b>{" "}
                        <input                          
                          ...
                          onChange={(e) => setDataDinhMuc({...datadinhmuc, LOSS_SX2: Number(e.target.value) })}
                        ></input>
                      </label>
                </div>            
              <div className='forminputcolumn'>
                      <label>
                        ...
                        <input                         
                          ...
                          onChange={(e) => setDataDinhMuc({...datadinhmuc, LOSS_SETTING1: Number(e.target.value) })}
                        ></input>
                      </label>
                      <label>
                        <b>LOSS SETTING2 (m):</b>{" "}
                        <input                          
                          ...
                          onChange={(e) => setDataDinhMuc({...datadinhmuc, LOSS_SETTING2: Number(e.target.value) })}
                        ></input>
                      </label>
                </div>  
                <div className='forminputcolumn'>
                ...
                <label>
                  ...
                  <label>
                    ...
                    <input                      
                      ...
                      onChange={(e) => setDataDinhMuc({...datadinhmuc, NOTE: e.target.value })}
                    ></input>
                  </label>
