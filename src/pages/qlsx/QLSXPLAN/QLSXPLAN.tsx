    ...
    <div className='qlsxplan'>
      ...
      <div className='mininavitem'  onClick={() => setNav(1)} style={{backgroundColor:selection.tab1 === true ? '#02c712':'#abc9ae', color: selection.tab1 === true ? 'yellow':'yellow'}}>
       ...
       {/*  <div className='mininavitem'  onClick={() => setNav(2)} style={{backgroundColor:selection.tab2 === true ? '#02c712':'#abc9ae', color: selection.tab2 === true ? 'yellow':'yellow'}}>
        ...
        <div className='mininavitem'  onClick={() => setNav(5)} style={{backgroundColor:selection.tab5 === true ? '#02c712':'#abc9ae', color: selection.tab5 === true ? 'yellow':'yellow'}}>
          <span className='mininavtext'>
            TRA PLAN
          </span>
        </div>  
        ...
        <div className='mininavitem'  onClick={() => setNav(6)} style={{backgroundColor:selection.tab6 === true ? '#02c712':'#abc9ae', color: selection.tab6 === true ? 'yellow':'yellow'}}>
          <span className='mininavtext'>
            DATA SX
          </span>
        </div>  
        <div className='mininavitem'  onClick={() => setNav(7)} style={{backgroundColor:selection.tab7 === true ? '#02c712':'#abc9ae', color: selection.tab7 === true ? 'yellow':'yellow'}}>
          <span className='mininavtext'>
            PLAN STATUS
          </span>
        </div>  
        <div className='mininavitem'  onClick={() => setNav(8)} style={{backgroundColor:selection.tab8 === true ? '#02c712':'#abc9ae', color: selection.tab8 === true ? 'yellow':'yellow'}}>
          <span className='mininavtext'>
            EQ STATUS
          </span>
        </div>  
        <div className='mininavitem'  onClick={() => setNav(10)} style={{backgroundColor:selection.tab10 === true ? '#02c712':'#abc9ae', color: selection.tab10 === true ? 'yellow':'yellow'}}>
          <span className='mininavtext'>
            KHO ẢO
          </span>
        </div> 
