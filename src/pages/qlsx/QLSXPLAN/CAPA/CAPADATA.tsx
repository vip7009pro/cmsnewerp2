...
import { RootState } from "../../../../redux/store";
  ...
  const CAPADATA = () => {
    ...
    const [dataleadtimecapa, setDataLeadTimeCapa] = useState<Array<CAPA_LEADTIME_DATA>>([]);
      ...
      <div className='tinhinhcuonlieu'>
        <div className='tracuuDataInspection'>
          ...
          <div className='tracuuYCSXTable'>
            <span style={{fontSize:20, display:'flex', alignSelf:'center', fontWeight:'bold', color:'blue'}}> {selectedG_NAME}</span>
            {materialDataTable}
          </div>
          {showhidePivotTable && (
