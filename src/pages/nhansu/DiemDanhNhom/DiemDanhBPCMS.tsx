...
const DiemDanhNhomBPCMS = () => {
  ...
  >([]);
   const columns_diemdanhnhom = [
     { field: "id", headerName: "STT", width: 30, headerClassName: 'super-app-theme--header' },
     ...
     { field: "FULL_NAME", headerName: "FULL_NAME", width: 120, headerClassName: 'super-app-theme--header', cellRenderer: (params: any) => { 
       return (
         <span style={{ fontWeight: "bold", color: params.data.ON_OFF === 1 ? "green" : params.data.ON_OFF === 0 ? "red" : "" }}>{params.data.FULL_NAME}</span>
       ) 
      } },
     {
       field: "AVATAR",
       ...
       cellRenderer: (params: any) => {
             ...
             if (type === 1) {
               ...
               generalQuery("setdiemdanhnhom", {
                 ...
                 .then((response) => {
                   ...
                   if (response.data.tk_status === "OK") {
                     const newProjects = diemdanhnhomtable.map((p) =>
                       p.EMPL_NO === params.data.EMPL_NO ? { ...p, ON_OFF: 0 } : p
                     );
                     if (params.data.OFF_ID === null) {
                       dangkynghi_auto(5);
                     }
         ...
         return (
           <div className='onoffdiv'>
             <span style={{color: params.data.ON_OFF === 1 ? "green" : "red",}}>
     ...
     },
     {
       ...
       cellRenderer: (params: any) => {
         ...
         return (
           <div className='onoffdiv'>
             <span style={{color: params.data.OVERTIME === 1 ? "green" : "red"}}>
     ...
     { field: "PHONE_NUMBER", headerName: "PHONE_NUMBER", width: 80, headerClassName: 'super-app-theme--header' },  
     { field: "FACTORY_NAME", headerName: "FACTORY_NAME", width: 80, headerClassName: 'super-app-theme--header' },
     { field: "JOB_NAME", headerName: "JOB_NAME", width: 60, headerClassName: 'super-app-theme--header' },
     { field: "WORK_SHIF_NAME", headerName: "TEAM", width: 60, headerClassName: 'super-app-theme--header' },
     {
       field: "WORK_POSITION_NAME",
       headerName: "VI TRI",
       width: 60, headerClassName: 'super-app-theme--header',
     },
     { field: "SUBDEPTNAME", headerName: "SUBDEPTNAME", width: 80, headerClassName: 'super-app-theme--header' },
     { field: "MAINDEPTNAME", headerName: "MAINDEPTNAME", width: 80, headerClassName: 'super-app-theme--header' },
     {
       field: "REQUEST_DATE",
     ...
     { field: "APPROVAL_STATUS", headerName: "TT_PHEDUYET", width: 80, headerClassName: 'super-app-theme--header' },
     { field: "REASON_NAME", headerName: "REASON_NAME", width: 80, headerClassName: 'super-app-theme--header' },
     { field: "OFF_ID", headerName: "OFF_ID", width: 80, headerClassName: 'super-app-theme--header' },
     { field: "CA_NGHI", headerName: "CA_NGHI", width: 80, headerClassName: 'super-app-theme--header' },
     { field: "ON_OFF", headerName: "ON_OFF", width: 80, headerClassName: 'super-app-theme--header' },
     { field: "OVERTIME_INFO", headerName: "OVERTIME_INFO", width: 80, headerClassName: 'super-app-theme--header' },
     { field: "OVERTIME", headerName: "OVERTIME", width: 80, headerClassName: 'super-app-theme--header' },
     { field: "REMARK", headerName: "REMARK", width: 80, headerClassName: 'super-app-theme--header' },
   ];
...
export default DiemDanhNhomBPCMS;
