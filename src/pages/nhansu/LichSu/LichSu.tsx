    ...
    function CustomToolbar() {
        return (
          <GridToolbarContainer>
            ...
            <button className='saveexcelbutton' onClick={()=>{SaveExcel(diemdanhnhomtable,"LichSuLamViec")}}>Save Excel</button>
          </GridToolbarContainer>
        );
      }
  ...
  return (
    <div className='lichsu'> 
          ...
          <div className='filterform'>            
            <label><b>Từ ngày:</b><input type='date' value={fromdate.slice(0,10)} onChange={e => setFromDate(e.target.value)}></input></label>                
            <label><b>Tới ngày:</b> <input type='date' value={todate.slice(0,10)} onChange={e => setToDate(e.target.value)}></input></label> 
