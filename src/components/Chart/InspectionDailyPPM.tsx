...
const InspectionDailyPPM = ({dldata} : DailyData) => {
  ...
  return (
    ...
    >
      ...
      <Bar stackId='a' yAxisId="left-axis" type="monotone" dataKey="PROCESS_PPM" stroke="white" fill='#cc66ff' label={{ position: 'top', formatter: labelFormatter }}>      
      </Bar>
      <Bar stackId='a' yAxisId="left-axis" type="monotone" dataKey="MATERIAL_PPM" stroke="white" fill='#00cc00' label={{ position: 'bottom', formatter: labelFormatter }}>      
      </Bar>
    </ComposedChart>
    </CustomResponsiveContainer>
  )
