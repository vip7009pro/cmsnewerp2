  ...
  return (
    <CustomResponsiveContainer>
      ...
      >
        ...
        <XAxis dataKey='SX_DATE' height={40} tick={{fontSize:'0.7rem'}}>         
        ...
        >          
          <LabelList dataKey="PLAN_QTY" fill="gray" position="inside" formatter={labelFormatter} fontSize={"0.7rem"} />
        </Bar>
        <Bar
          stackId='b'
          yAxisId='left-axis'
          ...
          /* label={{ position: "insideTop", formatter: labelFormatter,fontSize:'0.7rem', fontWeight:'bold', color:'black' }}    */      
        >
          <LabelList dataKey="SX_RESULT" fill="white" position="inside" formatter={labelFormatter} fontSize={"0.7rem"} />
        </Bar>
        <Line
          yAxisId='right-axis'
          type='monotone'
...
export default SXDailyAchiveTrend;
