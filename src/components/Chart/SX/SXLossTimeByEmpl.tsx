...
import { nFormatter, CustomResponsiveContainer } from "../../../api/services/utilService";
import { WEB_SETTING_DATA } from "../../../api/GlobalInterface";
import { SX_LOSSTIME_BY_EMPL } from "../../../pages/qlsx/QLSXPLAN/interfaces/khsxInterface";
const SXLossTimeByEmpl = ({ data }: { data: SX_LOSSTIME_BY_EMPL[] }) => {
  ...
  const CustomLabel = ({
    ...
    return (
      ...
      >
        ...
        {value.toLocaleString("en-US",)} mins
        )
      </text>
    );
  };
...
export default SXLossTimeByEmpl;
