...
import { OQC_NG_BY_CUSTOMER, RND_NEWCODE_BY_CUSTOMER, WEB_SETTING_DATA } from "../../../api/GlobalInterface";
  ...
  const CustomLabel = ({
    ...
    return (
      ...
      >
        ...
        {value.toLocaleString("en-US",)} lot
        )
      </text>
    );
  };
...
export default OQCNGByCustomer;
