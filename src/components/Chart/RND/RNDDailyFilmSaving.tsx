    ...
    if (active && payload && payload.length) {      
      return (
        ...
        >
          <p>Ngày {label}:</p>
          <p className='label'>
          PLAN_DATE: {`${payload[0].payload.PLAN_DATE?.toLocaleString("en-US")}`} EA
          </p>
          <p className='label'>
  ...
  return (
    <CustomResponsiveContainer>
      ...
      >
        ...
        <XAxis dataKey='PLAN_DATE' height={40} tick={{fontSize:'0.7rem'}}>         
...
export default RNDDailyFilmSaving;
