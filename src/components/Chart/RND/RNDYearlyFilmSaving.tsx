    ...
    if (active && payload && payload.length) {      
      return (
        ...
        >
          <p>Năm {label}:</p>
          <p className='label'>
          Năm: {`${payload[0].payload.PLAN_YEAR.toLocaleString("en-US")}`} EA
          </p>
          <p className='label'>
  ...
  return (
    <CustomResponsiveContainer>
      ...
      >
        ...
        <XAxis dataKey='PLAN_YEAR' height={40} tick={{fontSize:'0.7rem'}}>         
...
export default RNDYearlyFilmSaving;
