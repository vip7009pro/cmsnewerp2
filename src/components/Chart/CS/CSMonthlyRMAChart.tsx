...
import { Bar, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ComposedChart, Label, Line, } from "recharts";
import {
  ...
  return (
    <CustomResponsiveContainer>
      ...
      >
        ...
        <XAxis dataKey='RT_YM' height={40} tick={{fontSize:'0.7rem'}}>         
...
export default CSMonthlyRMAChart;
