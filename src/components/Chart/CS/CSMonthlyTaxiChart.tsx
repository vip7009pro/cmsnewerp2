...
import { CS_REDUCE_AMOUNT_DATA, CS_TAXI_AMOUNT_DATA, DailyData, FcostData } from "../../../api/GlobalInterface";

const CSDMonthlyTaxiChart = ({
  dldata,
  processColor,
  materialColor,
  ...
  return (
    <CustomResponsiveContainer>
      ...
      >
        ...
        <XAxis dataKey='TAXI_YM' height={40} tick={{fontSize:'0.7rem'}}>         
...
export default CSDMonthlyTaxiChart;
