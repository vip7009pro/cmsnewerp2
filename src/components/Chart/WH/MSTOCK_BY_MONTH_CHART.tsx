...
import { M_STOCK_BY_MONTH_DATA } from "../../../pages/kho/interfaces/khoInterface";

const MSTOCK_BY_MONTH_CHART = ({ data }: { data: M_STOCK_BY_MONTH_DATA[] }) => {
...
export default MSTOCK_BY_MONTH_CHART;
