...
import { M_OUTPUT_BY_POPULAR_DATA } from "../../../pages/kho/interfaces/khoInterface";
const M_OUTPUT_BY_POPULAR_CHART = ({ data }: { data: M_OUTPUT_BY_POPULAR_DATA[] }) => {
  ...
  const CustomLabel = ({
    ...
    return (
      ...
      >
        {data[index].PHANLOAI} : (
        {value.toLocaleString("en-US",{minimumFractionDigits: 0, maximumFractionDigits: 0})} m²
        )
      </text>
    );
  };
...
export default M_OUTPUT_BY_POPULAR_CHART;
