...
const PivotTable = ({datasource, tableID}:{datasource:PivotGridDataSource, tableID: string}) => {
  ...
  return (
    <div className='pivotdatatable'>
        ...
        >
           <FieldChooser enabled={true} height={600} width={600} allowSearch={true} title={'PIVOT TABLE'}/>
          <Export enabled={true} />
        </PivotGrid>
    </div>
  )
